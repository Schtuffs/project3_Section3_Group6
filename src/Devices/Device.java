...
public abstract class Device {
    ...
    public enum COMMAND_GET {
        ...
        // Coffee Machine, bean related
        BEAN_FLAVOUR, BEAN_LEFT, BEAN_BREWTIME, BEAN_MAKETIME, BEAN_BREWTIMELEFT, BEAN_BREWCOST, BEAN_DAYS, BEAN_IS_ON,

        // Shower
        SHOWER_TEMPERATURE, SHOWER_HEADTYPE, SHOWER_STATE,
